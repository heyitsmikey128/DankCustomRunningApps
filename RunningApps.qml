...
Item {
    ...
    readonly property int itemSize: Math.max(48, Theme.barIconSize(root.barThickness) + 8)
    ...
    readonly property int calculatedSize: {
        ...
        if (widgetData?.runningAppsCompactMode !== undefined ? widgetData.runningAppsCompactMode : SettingsData.runningAppsCompactMode) {
            ...
            return windowCount * itemSize + (windowCount - 1) * Theme.spacingXS + horizontalPadding * 2;
        } else {
            //return windowCount * (24 + Theme.spacingXS + 120) + (windowCount - 1) * Theme.spacingXS + horizontalPadding * 2;
            return windowCount * (itemSize + Theme.spacingXS + 120) + (windowCount - 1) * Theme.spacingXS + horizontalPadding * 2;
        }
    }
        ...
        Row {
            ...
            Repeater {
                ...
                delegate: Item {
                    ...
                    readonly property real visualWidth: (widgetData?.runningAppsCompactMode !== undefined ? widgetData.runningAppsCompactMode : SettingsData.runningAppsCompactMode) ? root.itemSize : (root.itemSize + Theme.spacingXS + 120)
                    ...
                    Rectangle {
                        ...
                        IconImage {
                            ...
                            // width: Theme.barIconSize(root.itemSize)
                            // height: Theme.barIconSize(root.itemSize)
                            width: root.itemSize - 8
                            height: root.itemSize - 8
                            source: {
                                root._desktopEntriesUpdateTrigger;
